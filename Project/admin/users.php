                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                       ...
                       foreach($data as $row){
                          ...
                          <td>{$row['email']}</td>
                          <td>{$row['active']}</td>
                          <td><a  href='./edituser.php?id={$row['user_id']}'><img  img src='./images/edit.png' alt='Edit'> </a></td>
                          <td><a  href='./deleteUser.php?id={$row['user_id']}'><img  img src='./images/delete.png' alt='Delete'> </a></td>
