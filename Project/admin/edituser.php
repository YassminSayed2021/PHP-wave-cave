...
if(isset($_POST['update'])){
    if(isset ($_POST['active']) )
		...
		$query="UPDATE users
		SET full_name='$fullname',user_name='$username',email='$email',active='$active',password='$password'
		WHERE user_id=$id";
									...
									<form method="post" action="<?php '_PHP_SELF';?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required" class="form-control " name="first-name">
											</div>
										</div>
										<div class="item form-group">
