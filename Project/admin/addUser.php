...
//if(isset($_POST['add'])){
  //  if(!empty($_POST['first-name'])&& !empty($_POST['user-name']) && !empty($_POST['email'])&&!empty($_POST['password'])){
		

	//	if(isset($_POST['active'])=='yes'){
	//		$_POST['active']="yes";
	//	}else{
	//		$_POST['active']="no";
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form  method="post" action="users.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Full Name <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input  name="first-name" type="text" id="first-name" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<button class="btn btn-primary" type="button" name="delete">Cancel</button>
