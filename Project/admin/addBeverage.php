...
if(isset($_POST['add'])){
	if(!empty($_POST['title'])&& !empty($_POST['content']) && !empty($_POST['price'])&&!empty($_POST['image'])){
		if(isset ($_POST['active_b']) )
        {
            $active = "Yes";
        }
        else
 ...
 $sql= "INSERT INTO beverages(title,description,price,active_b,image,cat_id) Values(?,?,?,?,?,?)";
 $stmt= $conn->prepare($sql);
 $stmt->execute([$title,$content,$price,$active,$image,$cat]);
								...
								<div class="x_content">
									...
									<form action=<?php echo $_SERVER['PHP_SELF'];?> method="post"  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" name="active_b">
												</label>
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="category" id="">
													...
													<option value="3">Iced Juices</option>
												</select>
											</div>
										</div>
