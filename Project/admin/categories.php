                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                       ...
                       foreach($data as $row){
                         echo "<tr>
                       <td>{$row['cat_name']}</td>
                       <td><a  href='./editCategory.php?id={$row['cat_id']}'><img  img src='./images/edit.png' alt='Edit'> </a></td>
                       <td><a  href='./deleteCategory.php?id={$row['cat_id']}'><img  img src='./images/delete.png' alt='Delete'> </a></td>
